#include "PRAO_lpa3.h" // Include the header file defining the class interface and base classes
...
bool PRAO_lpa3::fill_buffer() 
{
    ...
    size_t data_read_so_far = static_cast<size_t>(data_read_so_far_off) / header.nchann;
    ...
    size_t space_available = (buf_size - buf_max)/header.nchann; // Space left in the buffer
												 //
